...
import { selectAllTreats, selectAllTreatCategories } from "../api/ranching-treats";
...
const tRow = (i: number, treat: TreatEntry) => {
    const wikiUrl = treat.url ? treat.url : "https://palia.wiki.gg/";
        ...
        <div className="container-fluid ">
            ...
            <div className="row my-1">
                <div className="col-12">
                    <div id="TreatTable" className="container-fluid overflow-x-auto card ">
