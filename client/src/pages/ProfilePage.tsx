...
const ProfilePage = () => {
    ...
    return (
        <div className="container p-2">
            ...
            {isAdmin && (
                <div className="row py-1">
                    <div className="col">user is admin - display edit options for content</div>
                    <div className="col">
                        <Link
                            to="/admin"
                            title="Go to admin page"
                            className="text-decoration-none border rounded-2 border-dark bg-secondary p-2 text-center"
                            style={{ color: "inherit" }}>
                            Go to admin page
                        </Link>
                    </div>
