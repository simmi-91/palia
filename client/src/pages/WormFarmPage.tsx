...
import { textIcon, icoCoin, icoStar, icoFocus, icoWorm, icoGlowWorm } from "../app/icons/common";
        ...
        if (sortOn === "name") {
            ...
            let sorted = [...data].sort((a, b) => {
                ...
                if (sortOn === "gold") {
                    ...
                    aVal = aObj.glowworms.wormOutput ? aObj.glowworms.wormOutput : defaultVal;
                    bVal = bObj.glowworms.wormOutput ? bObj.glowworms.wormOutput : defaultVal;
